...
const tableBody = [
  ...
  { id: 6, item: 1, transfer: false, sort: '美容美髮', way: '信用卡', account: '兆豐商銀', description: null, tag: '昂貴染護髮', date: '2023-03-19', expense: 6473, },
  { id: 7, item: 0, transfer: false, sort: '中獎', way: '轉帳', account: '第一銀行', description: null, tag: '少少薪資', date: '2023-03-19', expense: 2452, },
  { id: 8, item: 0, transfer: false, sort: '獎金', way: '轉帳', account: '聯邦銀行', description: null, tag: '少少薪資', date: '2023-04-19', expense: 7457, },
  ...
  { id: 11, item: 1, transfer: false, sort: '美容美髮', way: '信用卡', account: '兆豐商銀', description: null, tag: '昂貴染護髮', date: '2023-04-19', expense: 5576, },
