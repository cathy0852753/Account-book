...
const tableBody = [
  ...
  { id: 10, item: 1, transfer: true, sort: '電子票證加值', way: '轉帳', account: '台新銀行', description: null, tag: '悠遊卡', date: '2023-08-19', expense: 1000, },
  { id: 11, item: 1, transfer: false, sort: '美容美髮', way: '信用卡', account: '兆豐商銀', description: null, tag: '昂貴染護髮', date: '2023-02-19', expense: 1000, },
  { id: 12, item: 0, transfer: false, sort: '外幣買賣', way: '轉帳', account: '土地銀行', description: null, tag: '少少薪資', date: '2023-03-19', expense: 1000, },
  { id: 13, item: 0, transfer: false, sort: '外幣買賣', way: '轉帳', account: '華南銀行', description: null, tag: '少少薪資', date: '2023-04-19', expense: 1000, },
  { id: 14, item: 1, transfer: false, sort: '服飾', way: '轉帳', account: '王道銀行', description: null, tag: '悠遊卡', date: '2023-05-19', expense: 1000, },
  { id: 15, item: 1, transfer: false, sort: '服飾', way: '轉帳', account: '連線銀行', description: null, tag: '悠遊卡', date: '2023-05-19', expense: 1000, },
  { id: 16, item: 1, transfer: false, sort: '服飾', way: '現金', account: '現金', description: null, tag: '悠遊卡', date: '2023-05-19', expense: 1000, },
  { id: 17, item: 0, transfer: false, sort: '回饋', way: '現金', account: '現金', description: null, tag: '悠遊卡', date: '2023-05-19', expense: 1000, },
  { id: 18, item: 1, transfer: true, sort: '電子票證加值', way: '轉帳', account: '王道銀行', description: null, tag: '悠遊卡', date: '2023-05-19', expense: 1000, },
  { id: 19, item: 0, transfer: false, sort: '回饋', way: '轉帳', account: '玉山銀行', description: null, tag: '悠遊卡', date: '2023-05-19', expense: 1000, },
  { id: 20, item: 1, transfer: true, sort: '電子票證加值', way: '轉帳', account: '王道銀行', description: null, tag: '悠遊卡', date: '2023-07-19', expense: 1000, },
]
const account = [
